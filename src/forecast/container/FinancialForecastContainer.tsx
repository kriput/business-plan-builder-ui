...
import {PieChartOutlined, FallOutlined, RiseOutlined} from '@ant-design/icons'
  ...
  const items: TabsProps["items"] = [
    {
      ...
      children: <ProductOverview fetchForecast={getForecastById.refetch} financialForecast={getForecastById.data} />,
    },
    {
      key: "2",
      label: (
